...
def run_game():
    ...
    while not game_over:
        ...
        while game_close:
            ...
            game_over_message2 = message_font.render("1-Exit 2-Restart", True, white)
            game_display.blit(game_over_message1, [width / 3, height / 3])
            game_display.blit(game_over_message2, [width / 3, 250 ])
